...
public class MetadataTest {
	...
	private Saml2Settings getSettingFromAllProperties() throws Error {
		return new SettingsBuilder().fromFile("config/config.all.properties").build();
	}

	@Test
	public void shouldIncludeValidUntilAndDuration() throws CertificateEncodingException, Error {
		//given
	...
	@Test
	public void shouldIgnoreValidUntil() throws CertificateEncodingException, Error {
		//given
		Saml2Settings saml2Settings = getSettingFromAllProperties();
	...
	@Test
	public void shouldIgnoreCacheDuration() throws CertificateEncodingException, Error {
		//given
		Saml2Settings saml2Settings = getSettingFromAllProperties();
