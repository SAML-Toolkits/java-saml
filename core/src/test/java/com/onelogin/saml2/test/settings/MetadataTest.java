...
public class MetadataTest {
	...
	public void testToAttributeConsumingServiceXmlSingleACSSpecialChars() throws IOException, CertificateEncodingException, Error {
		...
		String headerStr = "<md:AttributeConsumingService index=\"1\">";
		String sNameStr = "<md:ServiceName xml:lang=\"&amp;n\">My s&amp;rvice</md:ServiceName>";
		String sDescStr = "<md:ServiceDescription xml:lang=\"&amp;n\">My s&amp;rvice description</md:ServiceDescription>";
		String reqAttr1Str = "<md:RequestedAttribute Name=\"Email\" NameFormat=\"urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress\" FriendlyName=\"E-mail &quot;address&quot;\" isRequired=\"true\">";
		String reqAttr1Atr1Str = "<saml:AttributeValue xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\">foo&amp;bar@example.org</saml:AttributeValue>";
		String reqAttr1Attr2Str = "<saml:AttributeValue xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\">bar@example.org</saml:AttributeValue>";
		String reqAttr2Str = "<md:RequestedAttribute Name=\"FirstName&amp;LastName\" />";
		String footerStr = "</md:AttributeConsumingService>";
	...
	public void testToAttributeConsumingServiceXmlMultiServices() throws IOException, CertificateEncodingException, Error {
		...
		String sName2Str = "<md:ServiceName xml:lang=\"it\">Anagrafica &quot;completa&quot;</md:ServiceName>";
		String sDesc2Str = "<md:ServiceDescription xml:lang=\"it\">Dati anagrafici &quot;completi&quot;</md:ServiceDescription>";
		String reqAttr21Str = "<md:RequestedAttribute Name=\"Birth date\" />";
		String reqAttr22Str = "<md:RequestedAttribute Name=\"First &amp; Last Name\" isRequired=\"true\" />";
